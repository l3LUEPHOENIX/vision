        ...
        if request.form["actionType"] == "UPDATE":
            data = {
                "$set": {
                    ...
                    "containerIds": [
                        request.form[containerId]
                        for containerId in request.form.keys()
                        if "containerId" in containerId
                        and request.form[containerId] != ""
                    ],
                }
            }
...
if __name__ == "__main__":
    ...
    app.run(
        host="0.0.0.0",
        port=7443,
        ssl_context=("/opt/vision/secrets/cert.pem", "/opt/vision/secrets/key.pem"),
    )
